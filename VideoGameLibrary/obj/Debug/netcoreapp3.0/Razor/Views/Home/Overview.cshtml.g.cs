#pragma checksum "D:\Playstation-Library\Playstation-Game-Library\VideoGameLibrary\Views\Home\Overview.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c6f4ca2829903c3e7ee139599631f9b105388d65"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c6f4ca2829903c3e7ee139599631f9b105388d65", @"/Views/Home/Overview.cshtml")]
    ...
    public class Views_Home_Overview : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "D:\Playstation-Library\Playstation-Game-Library\VideoGameLibrary\Views\Home\Overview.cshtml"
...
<p>&nbsp;</p>
<p>I went with a MVC approach for this so that I could separate the different aspects of the app yet maintain a loose coupling between these elements, it also helps fo");
            WriteLiteral(@"r some unit testing and to manage the complexity of the app, as it enables aspects to run separately. I added my model class (&ldquo;Game&rdquo;) first with the minimum amount of data I needed just so that I can get the app working. This was created first as I could use Visual Studio to help by Scaffolding it, this would create the needed Controller(&ldquo;GamesController&rdquo;) and Views(&ldquo;Create&rdquo;,&rdquo;Delete&rdquo;,&rdquo;Details&rdquo;,&rdquo;Edit&rdquo;,&rdquo;Index&rdquo;) in a CRUD model. However if I ran the app at this point I would get an error as we don&rsquo;t have a database set up to store the data.</p>
<p>&nbsp;</p>
...
<p>The majority of these changes involved just adding some validation to my fields in order to keep things &ldquo;DRY&rdquo; the validation provided in MVC works extremely we");
            WriteLiteral(@"ll for this, allowing me to just set validation rules in the model. I added a bunch of these in all different shapes and sizes, this includes things like the Genre only allowing letters and each word starting with a capital letter and if incorrect it will give an Error in the UI.</p>
...
<p>I set up a model to store this new data, then when using the create feature it will go off and call the API using &ldquo;RestSharp&rdquo;. I only picked RestSharp as I originally tested that my API calls worked using Postman and it gives you the code to use with RestSharp");
            WriteLiteral(@" in .net, saving me time and effort. Now when a new game is added to the app it will auto fetch the description and the aggregated score, the description can only be seen on the details page.</p>
<p>&nbsp;</p>
